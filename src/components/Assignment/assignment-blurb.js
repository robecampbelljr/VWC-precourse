...
function Assignmentblurb() {
  ...
  return(
    <>
      <div className="blurb">
        To <strong>declare</strong> a variable is to create a container in memory to which we can then <strong>assign</strong> a value. A value can be a
        basic (i.e. string) or complex (i.e. Array) data type. These values can later be referenced, manipulated, or reassigned throughout the code. In JavaScript there are three ways of declaring a variable:
        <ul>
